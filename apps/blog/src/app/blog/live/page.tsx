import { getLivePosts } from "../../../lib/contentstack"
...
export default async function LivePage({
  ...
  const posts: BlogEntry[] = (await getLivePosts()) as BlogEntry[]

  if (!posts.length) {
    return <p className="text-center py-10 text-red-500">No Live posts found.</p>
  }
